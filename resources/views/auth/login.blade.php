                ...
                <div class="sign-in-from">
                    ...
                    <form class="mt-4" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <input id="exampleInputPassword1" type="password" class="form-control mb-0 @error('password') is-invalid @enderror" name="password" placeholder="Password" required autocomplete="current-password">
