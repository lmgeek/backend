                            ...
                            <div class="table-editable">
                                <div class="d-block float-left mb-3 mr-2">
                                    <div class="btn-group btn-group-md" role="group" aria-label="Basic example">
                                        <button type="button" onclick="window.location.href='{{ route('users.create') }}'" class="btn btn-primary">
                                ...
                                <span class="table-add float-right mb-3 mr-2">
                                        <button type="button" onclick="window.location.href='{{ route('users.create') }}'" class="btn btn-primary mb-3">
