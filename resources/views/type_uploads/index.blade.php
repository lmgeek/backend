                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">@lang('models/typeUploads.plural')</h4>
                        </div>
                    </div>
                        ...
                        <div class="table-editable">
                            <div class="d-block float-left mb-3 mr-2">
                                <div class="btn-group btn-group-md" role="group" aria-label="Basic example">
                                    <button type="button" onclick="window.location.href='{{ route('typeUploads.create') }}'" class="btn btn-primary">
                            ...
                            <span class="table-add float-right mb-3 mr-2">
                                        <button type="button" onclick="window.location.href='{{ route('typeUploads.create') }}'" class="btn btn-primary mb-3">
                                            <i class="fa fa-plus-square fa-lg"></i> Add New</button>
                                </span>
                            @include('type_uploads.table')
